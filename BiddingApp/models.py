...
class BuyerProductBidding(models.Model):
    ...
    product_delivery_date = models.CharField(max_length=100,null=True,blank=True)
    product_rfq_currency = models.CharField(max_length=100,null=True,blank=True)
    product_rfq_category = models.CharField(max_length=500, null=True, blank=True)
    product_department=models.CharField(max_length=300,null=True,blank=True)
...
class BiddingTermMasterSettings(models.Model):
    ...
    description_code=ArrayField(models.CharField(max_length=800,blank=True,null=True))
    terms_status=ArrayField(models.CharField(max_length=800,blank=True,null=True,default='Active'))
    created_on = models.DateTimeField(auto_now_add=True)
    updated_on = models.DateTimeField(auto_now=True)
...
class SourceList_CreateItems(models.Model):
    ...
    annual_consumption=models.CharField(max_length=200,null=True,blank=True)
    source_required_city=models.CharField(max_length=200,null=True,blank=True)
