...
class PurchaseOrder(models.Model):
    ...
    attachment1 = models.FileField(upload_to='POfile', null=True)
    attachment2 = models.FileField(upload_to='POfile', null=True)
    attachment3 = models.FileField(upload_to='POfile', null=True)
