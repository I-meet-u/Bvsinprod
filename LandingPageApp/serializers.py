...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=Message
        fields=['sender','receiver','messages','created_time','company_name_sender','company_name_receiver','sender_files','receiver_files','sender_images','receiver_images','sender_designation','receiver_designation','sender_name','receiver_name']