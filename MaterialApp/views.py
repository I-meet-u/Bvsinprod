    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            if type == 'auto':
                if vedordetailsobj:
                    vendorobj = VendorProduct_BasicDetails.objects.create(core_sector=core_sector, category=category,sub_category=sub_category,product_category=product_category,item_type=item_type,item_code=vedordetailsobj[0].get('numeric'),item_name=item_name,final_selling_price=final_selling_price,
                                                                          ...
                                                                          currency=currency,pricing=pricing,request_on_quote=request_on_quote,price_range=price_range, created_by=userid,updated_by=SelfRegistration.objects.get(id=userid))
                else:
                    print('not exist')
                    vendorobj = VendorProduct_BasicDetails.objects.create(core_sector=core_sector, category=category,sub_category=sub_category,product_category=product_category,item_type=item_type, item_code=100001,item_name=item_name,final_selling_price=final_selling_price,
                                                                          numeric=100002, add_image1=add_image1,add_image2=add_image2, add_image3=add_image3,add_image4=add_image4,
                                                                          uom=uom, quantity=quantity,hsn_sac=hsn_sac,unit_price=unit_price,discount=discount, tax=tax, sku_id=sku_id,
                                                                          country_of_origin=country_of_origin,currency=currency,pricing=pricing,request_on_quote=request_on_quote,price_range=price_range,created_by=userid,
            ...
            if type == 'manual':
                ...
                if vedordetailsobj:
                    vendorobj = VendorProduct_BasicDetails.objects.create(core_sector=core_sector, category=category,sub_category=sub_category,product_category=product_category,item_name=item_name, item_type=item_type,item_code=item_code,
