...
class SelfRegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('username', 'password', 'confirm_password', 'last_login', 'contact_person', 'business_to_serve', 'country',
...
class ShippingAddressSeializer(serializers.ModelSerializer):
    class Meta:
